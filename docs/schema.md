...
이 저장소가 열여섯 번 겪은 '한 필드가 두 질문에 답한다'의 한 사례다. 전체 목록과
판별 체크리스트는 `docs/absence.md`.
...
없는 제도를 '자료 없음'으로 적으면 영영 오지 않을 것을 기다리게 된다. 선관위
개표현황(info.nec VCCP09)의 선거종류 목록이 1차 근거다.

| 회차 | 선거종류 | 새로 생긴 것 |
|---|---|---|
| 1·2회 (1995·1998) | 3 4 5 6 | — (비례 선거 자체가 없다) |
| 3회 (2002) | + 8 | 광역의원 비례 — 1인 2표제 도입 |
| 4회 (2006) | + 9 · 10 | 기초의원 비례 · 교육의원 |
| 5회 (2010) | + 11 | 교육감 |

1·2회 시·도의회 비례 **의석은 있었다** — 별도 정당투표 없이 지역구 득표비율로
배분했다. 그 당선인은 선관위 온라인 자료에 없다(후보자명부만 남아 있다).
**득표는 '없음'이고 의석은 '못 받음'이다** — 같은 회차의 같은 선거에서도 갈린다.
