...
| 기초단체장 | 4 | NEC live won | ⚠️ 무투표 누락 가능 (224 vs 명부 226) |
| 광역의원 지역구 | 5 | NEC live won | ⚠️ 무투표 누락 (686 vs 명부 804) |
| 광역의원 비례 | 8 | calc_proportional 추정 | ⚠️ 추정 (87, 명부 미연동) |

> ⚠️ **광역의원(tc5)·기초장(tc4)·광역비례(tc8)도 기초의원과 같은 무투표 누락 구조**가 있다
> (라이브 개표가 무투표 선거구를 빼먹음). 기초의원(tc6·tc9)은 EPEI01 명부 오버레이로 해결했으나,
> 광역·기초장은 **아직 미적용**. 동일하게 EPEI01_#{3,4,5} 명부로 오버레이하면 해결 가능(미완).
