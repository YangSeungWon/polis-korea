...
사용:
  .venv/bin/python scripts/audit_parse.py                 # 요약 funnel
  .venv/bin/python scripts/audit_parse.py --list leak     # 한 분류의 ntt_id 덤프
  .venv/bin/python scripts/audit_parse.py --json out.json # 기계용 리포트
  .venv/bin/python scripts/audit_parse.py --baseline      # 직전 리포트와 diff
"""
