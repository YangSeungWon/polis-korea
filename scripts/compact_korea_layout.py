...
SIDO_BASE_SHAPE = {
    ...
    '충청남도':       (4, 4),    # 16 (max legacy 16 fit) — row 13~16
    '세종특별자치시': (1, 4),    # 4 col 7 row 13~16
    '충청북도':       (3, 5),    # 15 (max legacy 14 fit) — col 8~10 row 13~17 dense
    '대전광역시':     (3, 3),    # 9 (max 7 + 여유 2)
    '대구광역시':     (4, 4),    # 16 (max 12 + 여유 4)
    '울산광역시':     (2, 3),    # 6 (정확)
    '전북특별자치도': (4, 5),    # 20 (max 15 + 여유 5)
    '경상남도':       (3, 8),    # 24 (max 22 legacy fit + 여유 2) — col 12~14 row 17~24
...
SIDO_OFFSET = {
    ...
    '대구광역시':     (11, 13),  # col 11~14 row 13~16 (충북 col 10 인접)
    '울산광역시':     (15, 14),  # col 15~16 row 14~16 (대구 col 14 인접)
    '대전광역시':     (7, 18),   # col 7~9 row 18~20 (충북 row 17 인접)
    '전북특별자치도': (3, 17),   # col 3~6 row 17~21 (충남 row 16 인접)
    '경상남도':       (11, 17),  # col 11~13 row 17~ (대구 row 16 + 충북 col 10 인접)
    '부산광역시':     (14, 17),  # col 14~18 row 17~21 (경남 col 13 + 울산 col 16 인접)
    '전라남도':       (3, 22),   # col 3~6 row 22~ (전북 row 21 인접)
    '광주광역시':     (7, 22),   # col 7~9 row 22~25 (대전 row 19 + 전남 col 6 인접)
