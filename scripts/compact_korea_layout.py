...
SIDO_BASE_SHAPE = {
    ...
    '인천광역시':     (3, 5),
    '서울특별시':     (7, 7),
    '경기도':         (11, 11),  # 121 - 49 (서울 exclude) = 72 (max 60)
...
SIDO_OFFSET = {
    ...
    '경기도':         (3, 0),    # col 3~13 row 0~10 (서울 exclude), shape (11, 11)로 변경
    '강원특별자치도': (14, 0),   # col 14~17 row 0~4 — 경기 col 13과 인접 (gap 0)
    '경상북도':       (14, 5),   # col 14~18 row 5~9
    '충청남도':       (3, 11),   # col 3~6 row 11~14 (경기 row 10 인접)
    '세종특별자치시': (7, 12),   # col 7 row 12~13
    '충청북도':       (8, 11),   # col 8~11 row 11~14
    '대구광역시':     (14, 10),  # col 14~17 row 10~12
    '울산광역시':     (18, 10),  # col 18~19 row 10~12
    '대전광역시':     (8, 15),   # col 8~10 row 15~17 (충북 row 11~14 인접, 상승)
    '전북특별자치도': (3, 15),   # col 3~6 row 15~18 (충남 row 11~14 인접, 상승)
    '경상남도':       (11, 13),  # col 11~14 row 13~18
    '부산광역시':     (15, 13),  # col 15~19 row 13~16 (대구·울산 row 12 인접)
    '광주광역시':     (3, 19),   # col 3~5 row 19~21 (전북 row 18 인접, 상승)
    '전라남도':       (6, 19),   # col 6~10 row 19~23 (광주·전북 인접)
    '제주특별자치도': (7, 24),   # col 7~9 row 24 (전남 row 23 인접)
}
