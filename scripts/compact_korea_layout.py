...
SIDO_SHAPE = {  # (width, height)
    '인천광역시':     (3, 5),  # 15 자리 (14 cells + 1 외곽)
    '서울특별시':     (7, 7),  # 49 (48 + 1)
    '경기도':         (11, 10), # 110, 서울 제외 후 61 자리. cells 60 ✓
    # 경기 서울 둘러쌈 위해 ring 모양 — 별도 처리
    '강원특별자치도': (4, 5),  # 20 (18 + 2)
    '충청북도':       (4, 4),  # 16 (14 + 2)
    '충청남도':       (4, 4),  # 16 (16 ✓)
    '세종특별자치시': (1, 2),  # 2 ✓
...
SIDO_OFFSET = {
    # 한국 지리 따라 시도 cluster들 인접 배치.
    # row 0~9 (북): 인천·서울·경기·강원
    '인천광역시':     (0, 4),    # col 0~2 row 4~8 (서울 서)
    '서울특별시':     (3, 3),    # col 3~9 row 3~9 (가운데)
    '경기도':         (3, 0),    # col 3~13 row 0~9 (서울 둘러쌈 — exclude 서울)
    '강원특별자치도': (14, 0),   # col 14~17 row 0~4 (북동)
    # row 10~14 (중): 충남·세종·충북·경북
    '충청남도':       (3, 10),   # col 3~6 row 10~13 (서)
    '세종특별자치시': (7, 11),   # col 7 row 11~12 (중)
    '충청북도':       (8, 10),   # col 8~11 row 10~13 (중동)
    '경상북도':       (14, 5),   # col 14~18 row 5~9 (동중·강원 아래)
    # row 11~14 (중남): 대구·대전·울산
    '대전광역시':     (8, 14),   # col 8~10 row 14~16
    '대구광역시':     (14, 10),  # col 14~17 row 10~12
    '울산광역시':     (18, 10),  # col 18~19 row 10~12
    # row 14~20 (남): 전북·광주·전남·경남·부산
    '전북특별자치도': (3, 14),   # col 3~6 row 14~17
    '광주광역시':     (3, 18),   # col 3~5 row 18~20 (전남광주)
    '전라남도':       (6, 18),   # col 6~10 row 18~22
    '경상남도':       (11, 13),  # col 11~15 row 13~17
    '부산광역시':     (15, 14),  # col 15~19 row 14~17
    # row 22 (남단): 제주
    '제주특별자치도': (7, 23),   # col 7~9 row 23 (남쪽 단독)
}
