...
SIDO_BASE_SHAPE = {
    ...
    '충청남도':       (4, 4),    # 16 (max legacy 16 fit) — row 13~16 (전북 row 17 인접)
    '세종특별자치시': (1, 4),    # 4 col 7 row 13~16
    '충청북도':       (4, 4),    # 16 (max 14 + 여유 2) — row 13~16 (대전 row 17 인접)
...
SIDO_OFFSET = {
    ...
    '대구광역시':     (12, 13),  # col 12~15 row 13~16 (충북 col 11 + 경북 col 12 인접)
    '울산광역시':     (16, 14),  # col 16~17 row 14~16
    '대전광역시':     (7, 17),   # col 7~9 row 17~19 (충북 row 16 인접)
    '전북특별자치도': (3, 17),   # col 3~6 row 17~21 (충남 row 16 인접)
    '경상남도':       (12, 17),  # col 12~14 row 17~ (대구 row 16 인접)
    '부산광역시':     (15, 17),  # col 15~19 row 17~21
