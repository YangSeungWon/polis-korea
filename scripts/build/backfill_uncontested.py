...
사용:
  .venv/bin/python scripts/build/backfill_uncontested.py 20            # 캐시/results/centroid 병합
  NEC_API_KEY=... .venv/bin/python scripts/build/backfill_uncontested.py 20  # 캐시 새로 받기
  .venv/bin/python scripts/build/backfill_uncontested.py 17,18,19,20,21,22   # 여러 회차
"""
