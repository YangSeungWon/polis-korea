...
1. geo *_simple.json 좌표 6자리 절삭 (14자리 → 6자리, ~0.1m 정밀도. 지도 영향 0).
2. fetch 대상 JSON minify (indent 제거). 사람이 편집하는 config(elections/sources)는 제외.
