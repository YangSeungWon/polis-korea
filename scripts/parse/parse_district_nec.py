...
사용:
  .venv/bin/python scripts/parse/parse_district_nec.py 19
  .venv/bin/python scripts/parse/parse_district_nec.py 21
  .venv/bin/python scripts/parse/parse_district_nec.py --all
"""
