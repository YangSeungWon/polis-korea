...
// 옛 정당 압축 라벨 — registry.json 등록약칭(abbr) 기준. timeline.json은 정식명으로 정규화됨.
// (등록약칭 없거나 시각 구분이 더 중요한 당은 관용 단축 유지)
Object.assign(PARTY_SHORT, {
  '국민의미래': '국힘비례', '더불어민주연합': '민주비례',
  '새누리당': '새누리', '새정치민주연합': '새정치연합', '한나라당': '한나라',
  '민주노동당': '민노당', '자유한국당': '한국당', '바른미래당': '바른',
  '새천년민주당': '새천년', '열린우리당': '열우',
  '민주통합당': '민통', '민주당': '민주', '통합진보당': '통진당',
  '신한국당': '신한국', '한나라당계열': '한나라', '새정치국민회의': '국민회의',
  // 등록약칭 정규화 — 정식명 → 등록약칭 (정규화로 약칭키는 데이터에 안 들어옴)
  '자유민주연합': '자민련', '민주자유당': '민자당', '민주정의당': '민정당',
  '자유선진당': '선진당', '평화민주당': '평민당', '통일국민당': '국민당',
  '새로운미래': '새미래',
  '기타': '기타',
});
