...
const PARTY_COLORS = {
  '더불어민주당':     '#004EA2',
  '더불어민주연합':   '#004EA2',  // 22대 총선 비례 위성정당
  '더불어시민당':     '#004EA2',  // 21대 총선 비례 위성정당
  '열린민주당':       '#1A6AC0',  // 21대
  '민주당':           '#004EA2',
  '새천년민주당':     '#004EA2',  // 16대 (노무현)
  '새정치국민회의':   '#004EA2',  // 15대 (김대중)
  '평화민주당':       '#004EA2',  // 13대 (김대중)
  '통일민주당':       '#004EA2',  // 13대 (김영삼)
  '민주통합당':       '#004EA2',  // 18대 대선 (문재인) / 19대 총선
  '대통합민주신당':   '#004EA2',  // 17대 대선 (정동영) — 더민주 계열 직계
  '통합민주당':       '#004EA2',  // 18대 총선
  '열린우리당':       '#004EA2',  // 17대 총선
  '새정치민주연합':   '#004EA2',  // 20대 총선 직전
  '국민의힘':         '#E61E2B',
  '국민의미래':       '#E61E2B',  // 22대 위성정당
  '미래통합당':       '#E61E2B',  // 21대
  '미래한국당':       '#E61E2B',  // 21대 위성정당
  '자유한국당':       '#E61E2B',  // 20대 대선
  '새누리당':         '#C9151E',  // 18·19·20대
  '한나라당':         '#0F8EB4',  // 17·18대 (구)
  '민주자유당':       '#0F8EB4',  // 14대
  '민주정의당':       '#0F8EB4',  // 13대
  '조국혁신당':       '#06275E',
  ...
  '국민의당':         '#01A14B',  // 안철수
  '바른미래당':       '#01A14B',  // 21대
  '국민통합21':       '#FFCC00',  // 16대 (정몽준)
  '민중당':           '#A5132F',
  '민생당':           '#10A66E',  // 21대 비례 (구 평화당 등 통합)
  '대한애국당':       '#3399FF',
  '녹색당':           '#7FBE26',
  '소나무당':         '#5DA532',
  '국가혁명당':       '#FFD700',
  ...
  '홍익당':           '#FFD700',  // 21·22대
  '자유당':           '#5A6E9C',
  '바른정당':         '#01B0AB',  // 19·20대 (유승민)

  // === 진보·노동 계열 ===
  '진보신당':         '#FF7A05',  // 18·19대 (정의당 전신)
