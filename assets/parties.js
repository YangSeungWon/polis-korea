...
const PARTY_COLORS = {
  // 위키 정당 entry infobox 색 — 시대별 차이는 PARTY_COLOR_PERIODS에서 보정.
  '더불어민주당':     '#004EA2',
  '더불어민주연합':   '#004EA2',  // 22대 총선 비례 위성정당
  '더불어시민당':     '#004EA2',  // 21대 총선 비례 위성정당
  '열린민주당':       '#1A6AC0',  // 21대
  '민주당':           '#004EA2',  // 5회 지선(2010) 등 시대별 다른 색은 PERIODS
  '새천년민주당':     '#00AA7B',  // 16대 — 청록 (당시 공식)
  '새정치국민회의':   '#009A44',  // 15대 — 녹색 (당시 공식)
  '평화민주당':       '#FFD700',  // 13대 — 황색 (DJ당)
  '통일민주당':       '#1A6AC0',  // 13대 (YS당)
  '민주통합당':       '#FFD504',  // 19대 총선(2012-04) 시점 노랑
  '대통합민주신당':   '#FF7F00',  // 17대 대선 (정동영) — 주황
  '통합민주당':       '#FFD504',  // 18대 총선 — 노랑
  '열린우리당':       '#FFD918',  // 17대 총선 — 노랑
