...
// 2026 지선 통합 — geojson(sido_simple)은 분리(광주광역시·전라남도)이나 결과·폴은 통합키.
// 분리 시도로 조회 실패 시 통합키로 fallback (지도 색칠용). 옛 회차는 분리키가 직접 매칭돼 미사용.
const SIDO_MERGE = { '광주광역시': '전남광주특별시', '전라남도': '전남광주특별시' };
